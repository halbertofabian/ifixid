      ...
      features: [
        {
          ...
          geometry: {
            type: 'Polygon',
            coordinates: ['@@ไaƨܡȸ੝ĬɻĠƅĉĬ¹ƛŁLŁóƛĊʩÑəĠɯбKᄑ@ōȌǇƏÜçŭůŗɃƐwȸÝxýƻƱɍ¤Ý౺ȘུŢऄēĔ܀L'],
        ...
        },
        {
          ...
          geometry: {
            type: 'Polygon',
            coordinates: ['@@K⶙ၵ@ট̺ᓋڐþȌǔ°ô¯ƾŗJÇ̼ǠŢxŰȢĶƨƆÆĶŌǓŤŗɚƏƒ@ł¼Řmƾçǈ»Ӱ̰ĶĵĊJĖƜ@ڲᲤJ௨I'],
        ...
        },
        {
          ...
          geometry: {
            type: 'Polygon',
            coordinates: ['@@⋒IôǇŹķƅƽլ@ƻŭ¯ŹƻƑbȫĉƧĉwºóƃÛÑƛĕbǓƱ¯LÅǫƏ¼ġƱƃƅʳƨōóç°ǩÛŗᏋ`ε@@ҀšǓ£ĕþ°๒ƽघŤ@'],
        ...
        },
        {
          ...
          geometry: {
            type: 'Polygon',
            coordinates: ['@@ĊaƧšƃōKŹȀkŎƅkŁĠVĩɼĉ˖þÑŗЏķƥIĕþƏwKÑƽÛƲwĕÒ¯Ȣŭ@ɥU@bੇ`εXmȮւڼaঊĠĀɦĊ'],
        ...
        },
        {
          ...
          geometry: {
            type: 'Polygon',
            coordinates: ['@@ූK᥄@¥ўƱĶĊŤkЄ@ѶƽÆţƲwƲϗŚÅÆƥ»ķxŗƨóKɃĊȋ¯ɍĬōǴ˕Ⱥə㔋@ů@@ࡄွ@@၀ؔ@'],
        ...
        },
        {
          ...
          geometry: {
            type: 'Polygon',
            coordinates: ['@@¤իÆૃƆĩaĉĸÑīƽĉbɥĉğÿউóÞVŮô°UŤÞΠƦǔôȌòèIȸˬĀƐƚýƒŘƐUĊŤɎȖw¦¼'],
        ...
        },
        {
          ...
          geometry: {
            type: 'Polygon',
            coordinates: ['@@ˬţĵʑƏÇóŹɰÛnīķҋʽͱǟīƱɃýƐʑê̙ȀkŮKn°°þĶɦèbÞʴƐ¦ôʇǞUłŁUĬźƦçĖɂǪ²ĠŌÒϮǿ'],
        ...
        },
        {
          ...
          geometry: {
            type: 'Polygon',
            coordinates: ['@@@Ƀ⍼@ĠŗÜLĸīmůƲƙźKÑŋÑ±ğɁǩèĕŹƥVīłVŁʈǝ¥óʳƏaÝɥçǝxƛğ᷇@࢓@@ޒ@ૼ@@ƾ°ӎȢ@a'],
        ...
        },
        {
          ...
          geometry: {
            type: 'Polygon',
            coordinates: ['@@㰤UkīɯǳƦǉȘī@ຝōm°çƥłĉÛÑǓñŭƼȁƱxÅŤѵƾЃ@ţlĵĉѝƲ¦᥃@෕Lؓ@Iဲ`@Iߔ'],
        ...
        },
        {
          ...
          geometry: {
            type: 'Polygon',
            coordinates: ['@@VĉŗƏþƑƏƙ˫ÿJȷñçóȋƥǓÝΟVţó¯UŭôÝڻbUôׄƃƒ°èóɰĬǠxǈýƲ°ƾWǪ࢈UڲV'],
        ...
        },
        {
          ...
          geometry: {
            ...
            encodeOffsets: [[[-77207, 38926]], [[-77840, 38865]], [[-80230, 40413]]]
          }
        },
        {
          type: 'Feature',
          ...
          geometry: {
            ...
            encodeOffsets: [[[-119842, 50177]], [[-125663, 49470]], [[-125977, 49751]]]
          }
        },
        {
          type: 'Feature',
